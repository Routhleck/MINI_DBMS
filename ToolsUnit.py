...
from utils import get_key, get_merge_cell_list, get_merge_map, assign_style, idx2letter
        ...
        for sheet, idxes in dict_sheet.items():
            ...
            for i in range(1, len(idxes) + 1):
                ...
                for j in range(1, num_column + 1):
                    ...
                    ws_tmp.column_dimensions[get_column_letter(j)].width = ws.column_dimensions[
                        get_column_letter(j)].width
